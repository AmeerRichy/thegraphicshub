  ...
  return (
    <section className="page">
      ...
      <div className="left">
        ...
        <div className="text">
          <h2>Your Vision.<br />Our Design.<br />Let’s Build It.</h2>
          <p>We craft meaningful digital experiences through design and code.</p>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .page {
          display: grid;
          grid-template-columns: 1fr 1.1fr; /* form side slightly larger */
          min-height: 100vh;
          background: var(--dark);
          color: #fff;
        ...
        .formBox {
          ...
          border-radius: 20px;
          padding: 50px 60px; /* more padding for squarish feel */
